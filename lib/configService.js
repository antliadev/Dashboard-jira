...
class ConfigService {
  ...
  getConfig() {
    ...
    return {
      baseUrl: this._config.baseUrl,
      email: maskedEmail,
      fullEmail: IS_PRODUCTION ? undefined : this._config.email,
      jql: this._config.jql,
      cacheTtlMinutes: this._config.cacheTtlMinutes,
      ...
      source: this._source,
      // Allow edit by default in production - user can fill form manually
      // Set JIRA_LOCK_CONFIG=1 to disable editing
      canEdit: process.env.JIRA_LOCK_CONFIG !== '1'
    };
  }
